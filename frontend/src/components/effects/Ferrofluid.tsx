/**
 * Ferrofluid 背景效果 (来自 React Bits 开源组件).
 *
 * 用 ogl WebGL 渲染动态流体效果. 默认用作 ChatArea 背景层,
 * opacity 低, 不影响文字阅读. 鼠标移动时会有磁性凸起交互.
 *
 * Props: 见 React Bits 文档, 完整支持 (colors / speed / turbulence / 等).
 */
